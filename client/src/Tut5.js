  ...
  return (
    <Fade in={show}>
        <div>
          ...
          <p>In order to make a transaction on the blockchain, it has to be transmitted to miners who validate the transaction to see if both parties
            ...
            If we transmit the block to the peers on the network, there will be two version of the blockchain: ours and the one of the peers. Because it is 2-to-1,
            our version of the blockchain will not be accepted in the network as more than half of the peers reach concensus on their version.  
            </p>
        </div>
    </Fade>
  );
