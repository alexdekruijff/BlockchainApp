    ...
    <Fade in={show}>
        <div>
          ...
          <p>
            ...
            the hashes of all the the blocks that come after it will also change! Let's try to add some more blocks
            and change the data in the first block we created to see what happens.</p>
        </div>
    </Fade>
  );
}
